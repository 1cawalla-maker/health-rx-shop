...
export default function GuideAreNicotinePouchesLegalAustralia() {
  const faq = [
    ...
    },
    {
      ...
      answer:
        'Start a secure booking and complete the clinical intake if prompted. A qualified doctor will make the final clinical assessment.',
    },
  ];
  ...
  return (
    <PublicLayout>
      <Seo
        ...
        canonicalPath={PATH}
        ogImagePath="/og/are-nicotine-pouches-legal-in-australia.png"
        ogType="article"
        jsonLd={[
          webPageSchema({
