  ...
  return (
    <PublicLayout>
      <Seo
        ...
        description="PouchCare terms of service for using our Australian telehealth platform."
        canonicalPath="/terms"
          ...
          <div className="max-w-3xl mx-auto prose prose-slate">
            ...
            <div className="space-y-8 text-muted-foreground">
              <section>
                ...
                <p>
                  By accessing and using the PouchCare platform ("Service"), you accept and agree to be bound
              ...
              <section>
                ...
                <p>
                  PouchCare provides a telehealth platform that connects patients with registered Australian
              ...
              <section>
                ...
                <p>
                  To the fullest extent permitted by law, PouchCare shall not be liable for any indirect,
