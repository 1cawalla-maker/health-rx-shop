  ...
  return (
    <PublicLayout>
      <Seo
        ...
        description="Learn how PouchCare works: secure booking, doctor consultation, clinical assessment, and ordering nicotine pouches in Australia through a compliant pathway."
        ...
        jsonLd={[
          webPageSchema({
            ...
            name: 'How it works',
            description:
              'Learn how PouchCare works: secure booking, doctor consultation, clinical assessment, and ordering nicotine pouches in Australia through a compliant pathway.',
          ...
          breadcrumbSchema({
            items: [
              ...
              { name: 'How It Works', url: `${SITE_ORIGIN}/how-it-works` },
            ],
          }),
          serviceSchema({
            url: `${SITE_ORIGIN}/how-it-works`,
        ...
        <div className="container">
          ...
          <div className="max-w-4xl mx-auto grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mt-1">Step-by-step from secure booking to consult.</p>
            </Link>
